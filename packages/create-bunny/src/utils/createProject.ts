...
import { existsSync, mkdir, readJsonSync } from "fs-extra";
import path from "node:path";
import {
  downloadAndExtractExample,
  downloadAndExtractRepo, existsInRepo, getRepoInfo, hasRepo,
  type RepoInfo
} from "./examples";
...
export async function createProject({
   ...
   */
  const loader = logger.bunnyLoader("Downloading files...");
  try {
